...
elseif &background == "dark"
    ...
    hi Conditional gui=NONE guifg=#782521 guibg=NONE
    ...
    hi Normal gui=NONE guifg=#878787 guibg=#080808
    ...
    hi Statement gui=NONE guifg=#dfc1b4 guibg=NONE
    hi StatusLine gui=NONE guifg=#a8a8a8 guibg=#292929
    hi StatusLineNC gui=NONE guifg=#787878 guibg=#292929
    hi StorageClass gui=NONE guifg=#978b59 guibg=NONE
    hi String gui=NONE guifg=#895434 guibg=NONE
    ...
    hi Todo gui=standout guifg=NONE guibg=NONE
    hi Type gui=NONE guifg=#b0988d guibg=NONE
    hi Underlined gui=NONE guifg=NONE guibg=NONE
